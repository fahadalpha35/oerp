    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row">
              ...
              <div class="col-12">
                <h3 class="mt-2 text-center">Give Attendance</h3>
                  <br>
                 ...
                 <br>
                        <div id="locationDisplay" class="p-2 text-center">
                          Your Current <span id="currentLat" style="color: blue">Latitude: Not available</span> <span id="currentLon" style="color: blue">Longitude: Not available</span>
                        </div>
                      </form>
                    </div>
              </div>
      ...
      if (distance <= 100) {
        ...
        document.getElementById('attendanceForm').addEventListener('submit', function(event) {
          ...
          if (attendance_id !== null) {
                ...
                axios.post('/submit_exit_time/'+ attendance_id, attendanceFormData).then(response => {
